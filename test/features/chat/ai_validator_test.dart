...
''';
      final response = ChatResponseMapper.validateResponse(raw);
...
''';
    ...
    test('當缺少必要欄位時應拋出 AiValidationException', () {
      ...
      expect(
        () => ChatResponseMapper.validateResponse(raw),
...
''';
      final response = ChatResponseMapper.validateSafeResponse(raw);
    ...
    test('當缺少必要欄位時應拋出 AiValidationException', () {
      ...
      expect(
        () => ChatResponseMapper.validateSafeResponse(raw),
        throwsA(isA<AiValidationException>()),
      );
    });

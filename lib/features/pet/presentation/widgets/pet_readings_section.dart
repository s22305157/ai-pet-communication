...
class _PetReadingsSectionState extends State<PetReadingsSection> {
  ...
  void initState() {
    super.initState();
    _readingsStream = _readingsRepository.watchReadingsByPetId(widget.pet.petId);
  }
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ReadingListTile(
                    ...
                    onDelete: () async {
                      await _readingService.deleteReading(widget.pet.petId, reading.id);
                      if (context.mounted) {
